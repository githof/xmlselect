...
var acte_jeronimo = '<ACTE id="58">3) <date>28-2-1656</date>: <epoux><prenom>Jerónimo</prenom> de <nom de="true">ILLESCAS</nom>,</epoux> con <epouse>Da. Petrona de TAPIA. </epouse>. Ts.: <temoins><temoin> el Licenciado Melchor Agustín de Mesa</temoin>,<temoin> Canónigo de esta Santa Iglesia</temoin>,<temoin> el General Dn. Luis de Aresti</temoin>,<temoin> el Capitán Tomás de Rojas y Acevedo y otros. Agregado: Jerónimo de Illescas y Da. Petrona Tapia de Agüero</temoin>,<temoin> hija legítima del Capitán Dn. Ñuño Fernández y Da. Juana de Agüero Tapia y Valdenebro</temoin>,<temoin> padres también del General Dn. Ignacio Fernández de Agüero. Al margen: murió el dicho</temoin>,</temoins>(f. 1).</ACTE>';
